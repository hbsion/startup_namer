...
/// with an icon.
class ExpandIconX extends StatefulWidget {
...
class _ExpandIconState extends State<ExpandIconX> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ExpandIconX oldWidget) {
